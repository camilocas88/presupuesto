!(function (e, t) {
	...
	function n(e) {
		var t = e.length,
			n = ie.type(e);
		return (
			'function' !== n && !ie.isWindow(e) && (!(1 !== e.nodeType || !t) || 'array' === n || 0 === t || ('number' == typeof t && t > 0 && t - 1 in e))
		);
	}
	function r(e, t, n) {
		if (ie.isFunction(t))
	...
	function a() {
		he.addEventListener
			? (he.removeEventListener('DOMContentLoaded', s, !1), e.removeEventListener('load', s, !1))
	...
	function y(e, t) {
		return ie.nodeName(e, 'table') && ie.nodeName(11 !== t.nodeType ? t : t.firstChild, 'tr')
	...
	function E(e) {
		...
		return (
			n ||
				((n = N(e, t)),
				('none' !== n && n) ||
					((Ke = (Ke || ie("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)),
		...
		for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
			(r = e[a]),
				r.style &&
					...
					(n = r.style.display),
					t
						? (o[a] || 'none' !== n || (r.style.display = ''), '' === r.style.display && Ae(r) && (o[a] = ie._data(r, 'olddisplay', E(r.nodeName))))
						: ((i = Ae(r)), ((n && 'none' !== n) || !i) && ie._data(r, 'olddisplay', i ? n : ie.css(r, 'display'))));
		for (a = 0; s > a; a++)
	...
	function F(e, t, n) {
		...
		n.queue ||
			...
			1 === e.nodeType &&
				...
				'inline' === c &&
					'none' === ie.css(e, 'float') &&
					(ne.inlineBlockNeedsLayout && 'inline' !== E(e.nodeName) ? (p.zoom = 1) : (p.display = 'inline-block'))),
			n.overflow &&
				((p.overflow = 'hidden'),
				ne.shrinkWrapBlocks() ||
					d.always(function () {
	...
	function B(e, t, n) {
		var r,
			...
			l = function () {
				if (i) return !1;
				for (
					var t = pt || q(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length;
					l > a;
					a++
				)
					u.tweens[a].run(o);
	...
	function z(e, t, n, r) {
		...
		for (o = c.shift(); o; )
			if (
				(e.responseFields[o] && (n[e.responseFields[o]] = t), !l && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), (l = o), (o = c.shift()))
			)
				if ('*' === o) o = l;
				else if ('*' !== l && l !== o) {
					if (((a = u[l + ' ' + o] || u['* ' + o]), !a))
						...
						(e = a[r]),
							...
							a !== n &&
								(u && n && (ie.isPlainObject(n) || (t = ie.isArray(n)))
									? (t ? ((t = !1), (o = e && ie.isArray(e) ? e : [])) : (o = e && ie.isPlainObject(e) ? e : {}), (a[r] = ie.extend(u, o, n)))
									: void 0 !== n && (a[r] = n));
			return a;
		}),
		ie.extend({
	...
	var ue = (function (e) {
			...
			if (!r && _) {
				...
				if (w.qsa && (!M || !M.test(e))) {
					if (((p = d = P), (h = t), (m = 1 !== s && e), 1 === s && 'object' !== t.nodeName.toLowerCase())) {
						for (
							u = E(e), (d = t.getAttribute('id')) ? (p = d.replace(xe, '\\$&')) : t.setAttribute('id', p), p = "[id='" + p + "'] ", l = u.length;
							l--;
			...
			for (
				...
				if ((n = T.relative[e[s].type])) c = [p(h(c), n)];
					...
					if (((n = T.filter[e[s].type].apply(null, e[s].matches)), n[P])) {
						...
						return v(
							s > 1 && h(c),
							s > 1 && f(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace(le, '$1'),
							n,
							r > s && y(e.slice(s, r)),
							i > r && y((e = e.slice(r))),
							i > r && f(e)
		...
		(w = t.support = {}),
					  ...
					  (w.qsa = ve.test(r.querySelectorAll)) &&
							(i(function (e) {
								(q.appendChild(e).innerHTML =
									"<a id='" + P + "'></a><select id='" + P + "-\f]' msallowcapture=''><option selected=''></option></select>"),
			...
			(t.matchesSelector = function (e, n) {
				if (
					((e.ownerDocument || e) !== H && L(e), (n = n.replace(de, "='$1']")), !(!w.matchesSelector || !_ || (F && F.test(n)) || (M && M.test(n))))
				)
					try {
						var r = O.call(e, n);
							...
							: function (t, n, l) {
									...
									if (g) {
										...
										if (((h = [a ? g.firstChild : g.lastChild]), a && y)) {
											for (
												c = g[P] || (g[P] = {}), u = c[e] || [], p = u[0] === W && u[1], f = u[0] === W && u[2], d = p && g.childNodes[p];
			...
			(E = t.tokenize = function (e, n) {
				...
				for (s = e, l = [], u = T.preFilter; s; ) {
					(!r || (i = ue.exec(s))) && (i && (s = s.slice(i[0].length) || s), l.push((o = []))),
						(r = !1),
						(i = ce.exec(s)) && ((r = i.shift()), o.push({ value: r, type: i[0].replace(le, ' ') }), (s = s.slice(r.length)));
					for (a in T.filter)
						!(i = he[a].exec(s)) || (u[a] && !(i = u[a](i))) || ((r = i.shift()), o.push({ value: r, type: a, matches: i }), (s = s.slice(r.length)));
					if (!r) break;
				}
		...
		ie.extend({
			...
			ready: function (e) {
				if (e === !0 ? !--ie.readyWait : !ie.isReady) {
					...
					(ie.isReady = !0),
						(e !== !0 && --ie.readyWait > 0) ||
							(we.resolveWith(he, [ie]), ie.fn.triggerHandler && (ie(he).triggerHandler('ready'), ie(he).off('ready')));
				}
			},
		}),
		...
		ie.fn.extend({
			...
			promise: function (e, t) {
				...
				for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; a--; )
					(n = ie._data(o[a], e + 'queueHooks')), n && n.empty && (r++, n.empty.add(s));
	...
	(ie.event = {
		...
		fix: function (e) {
			...
			var t,
				...
				a = this.fixHooks[i];
			for (
				a || (this.fixHooks[i] = a = qe.test(i) ? this.mouseHooks : He.test(i) ? this.keyHooks : {}),
			...
			return this instanceof ie.Event
				? (e && e.type
						? ((this.originalEvent = e),
						  (this.type = e.type),
						  (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? f : p))
						: (this.type = e),
				  t && ie.extend(this, t),
			...
			clone: function (e, t, n) {
				...
				if (
					(ne.html5Clone || ie.isXMLDoc(e) || !Be.test('<' + e.nodeName + '>')
						? (o = e.cloneNode(!0))
						: ((Qe.innerHTML = e.outerHTML), Qe.removeChild((o = Qe.firstChild))),
					...
					if (((o = e[h]), o || 0 === o))
						if ('object' === ie.type(o)) ie.merge(p, o.nodeType ? [o] : o);
							...
							if ((!ne.leadingWhitespace && Pe.test(o) && p.push(t.createTextNode(Pe.exec(o)[0])), !ne.tbody))
								for (o = 'table' !== l || $e.test(o) ? ('<table>' !== c[1] || $e.test(o) ? 0 : s) : s.firstChild, i = o && o.childNodes.length; i--; )
			...
			domManip: function (e, t) {
				...
				if (u && ((s = ie.buildFragment(e, this[0].ownerDocument, !1, this)), (n = s.firstChild), 1 === s.childNodes.length && (s = n), n)) {
					for (o = ie.map(g(s, 'script'), b), i = o.length; u > l; l++)
						(r = s), l !== d && ((r = ie.clone(r, !0, !0)), i && ie.merge(o, g(r, 'script'))), t.call(this[l], r, l);
					if (i)
						for (a = o[o.length - 1].ownerDocument, ie.map(o, x), l = 0; i > l; l++)
							(r = o[l]),
								Ue.test(r.type || '') &&
									!ie._data(r, 'globalEval') &&
									ie.contains(a, r) &&
									(r.src ? ie._evalUrl && ie._evalUrl(r.src) : ie.globalEval((r.text || r.textContent || r.innerHTML || '').replace(Je, '')));
					s = n = null;
				}
				return this;
			},
		...
		ie.each({ appendTo: 'append', prependTo: 'prepend', insertBefore: 'before', insertAfter: 'after', replaceAll: 'replaceWith' }, function (e, t) {
			ie.fn[e] = function (e) {
				for (var n, r = 0, i = [], o = ie(e), a = o.length - 1; a >= r; r++)
					(n = r === a ? this : this.clone(!0)), ie(o[r])[t](n), Q.apply(i, n.get());
		...
		style: function (e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var i,
					...
					s = ie.camelCase(t),
					l = e.style;
				if (((t = ie.cssProps[s] || (ie.cssProps[s] = S(l, s))), (a = ie.cssHooks[t] || ie.cssHooks[s]), void 0 === n))
					return a && 'get' in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
				if (
					((o = typeof n),
					'string' === o && (i = ut.exec(n)) && ((n = (i[1] + 1) * i[2] + parseFloat(ie.css(e, t))), (o = 'number')),
					null != n &&
						n === n &&
		...
		(H.propHooks = {
			_default: {
				...
				set: function (e) {
					ie.fx.step[e.prop]
						? ie.fx.step[e.prop](e)
						: e.elem.style && (null != e.elem.style[ie.cssProps[e.prop]] || ie.cssHooks[e.prop])
	...
	(ie.Animation = ie.extend(B, {
		...
		(ie.speed = function (e, t, n) {
			var r =
				e && 'object' == typeof e
					? ie.extend({}, e)
					: { complete: n || (!n && t) || (ie.isFunction(e) && e), duration: e, easing: (n && t) || (t && !ie.isFunction(t) && t) };
			return (
			...
			attr: function (e, t, n) {
				...
				if (e && 3 !== o && 8 !== o && 2 !== o)
					return typeof e.getAttribute === Ce
						? ie.prop(e, t, n)
						: ((1 === o && ie.isXMLDoc(e)) || ((t = t.toLowerCase()), (r = ie.attrHooks[t] || (ie.expr.match.bool.test(t) ? Tt : wt))),
						  void 0 === n
						...
						ie.isFunction(e)
							...
							: function () {
									if ('string' === n)
										...
										(n === Ce || 'boolean' === n) &&
											(this.className && ie._data(this, '__className__', this.className),
	...
	(qt = Wt.exec(_t.toLowerCase()) || []),
			...
			ajax: function (e, t) {
				function n(e, t, n, r) {
					...
					2 !== b &&
						...
						m.fireWith(f, [w, T]),
						l && (p.trigger('ajaxComplete', [w, d]), --ie.active || ie.event.trigger('ajaxStop')));
				}
				...
				if (
					...
					null == d.crossDomain &&
						...
						(d.crossDomain = !(
							!r ||
							(r[1] === qt[1] && r[2] === qt[2] && (r[3] || ('http:' === r[1] ? '80' : '443')) === (qt[3] || ('http:' === qt[1] ? '80' : '443')))
						))),
				...
				(l = ie.event && d.global),
					...
					(o = d.url),
					d.hasContent ||
						(d.data && ((o = d.url += (Lt.test(o) ? '&' : '?') + d.data), delete d.data),
						d.cache === !1 && (d.url = Ft.test(o) ? o.replace(Ft, '$1_=' + jt++) : o + (Lt.test(o) ? '&' : '?') + '_=' + jt++)),
					d.ifModified &&
						(ie.lastModified[o] && w.setRequestHeader('If-Modified-Since', ie.lastModified[o]),
					...
					w.setRequestHeader(
						...
						d.dataTypes[0] && d.accepts[d.dataTypes[0]]
							? d.accepts[d.dataTypes[0]] + ('*' !== d.dataTypes[0] ? ', ' + It + '; q=0.01' : '')
							: d.accepts['*']
					);
		...
		(ie.expr.filters.hidden = function (e) {
			return (
				...
				(!ne.reliableHiddenOffsets() && 'none' === ((e.style && e.style.display) || ie.css(e, 'display')))
			);
		}),
		...
		ie.ajaxPrefilter('json jsonp', function (t, n, r) {
			var i,
				...
				s =
					...
					(en.test(t.url)
						? 'url'
						: 'string' == typeof t.data && !(t.contentType || '').indexOf('application/x-www-form-urlencoded') && en.test(t.data) && 'data');
					...
					function (e, r, i) {
						...
						return void 0 === i
							? o
								...
								: e[r]
							: void (o ? o.scrollTo(n ? ie(o).scrollLeft() : i, n ? i : ie(o).scrollTop()) : (e[r] = i));
					},
					e,
					r,
					arguments.length,
				...
				n.preventDefault(),
					...
					s == l &&
						(m.hasClass(e.modalTarget + '-off') &&
							(m.removeClass(e.animatedOut), m.removeClass(e.modalTarget + '-off'), m.addClass(e.modalTarget + '-on')),
			...
			d.click(function (n) {
				n.preventDefault(),
					...
					m.hasClass(e.modalTarget + '-off') &&
						...
						m.one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', o));
			});
	};
})(jQuery);
!(function (n, r) {
	...
	function c(n) {
		...
		return (
			...
			e(n) && n.match('%v')
				...
				? n
				: e(r)
				? (s.settings.currency.format = { pos: r, neg: r.replace('%v', '-%v'), zero: r })
				: r
		);
	}
	var s = {};
	...
	(s.formatColumn = function (n, r, f, p, l, d) {
		...
		return i(x, function (n, r) {
			return e(n) && n.length < v
				? b
					? n.replace(h.symbol, h.symbol + new Array(v - n.length + 1).join(' '))
					: new Array(v - n.length + 1).join(' ') + n
				: n;
		});
	}),
		'undefined' != typeof exports
			? ('undefined' != typeof module && module.exports && (exports = module.exports = s), (exports.accounting = s))
...
$(document).on('ready', function () {
	var a = $('#share'),
		e = [
			{ share: 'facebook', label: a.data('facebook') },
			{ share: 'linkedin', label: a.data('linkedIn') },
			{ share: 'googleplus', label: a.data('google') },
			{ share: 'twitter', label: a.data('twitter'), text: a.data('twitter_text') },
		];
	a.jsSocials({ url: a.data('url'), showCount: !1, shareIn: 'popup', shares: e });
});
('use strict');
function init() {
	for (var e = document.getElementsByClassName('js--answer-image'), t = 0; t < e.length; t++)
		e[t].getAttribute('data-src') && (e[t].setAttribute('src', e[t].getAttribute('data-src')), e[t].removeAttribute('data-src'));
}
$(document).on('ready', function () {
	function e() {
		var e = $('#config'),
	...
	function t() {
		...
		function t() {
			for (var e = m.useMultipliers, t = e ? 1 : 0, n = 0; n < j.length; n++)
				e ? (t *= j[n].answerWeight) : (t += j[n].answerWeight * m.pricePerHour);
		...
		function r() {
			a(),
				d.results.fadeIn(600),
				ga('multidomain.set', 'page', '/ccm-' + m.appType + '/result'),
		...
		function i(e) {
			a(),
				n(),
				ga('multidomain.set', 'page', '/ccm-' + m.appType + '/step' + e),
				ga('multidomain.send', 'pageview'),
				d.questions.filter('[data-question-id="' + e + '"]').fadeIn(600);
		}
		function s() {
			for (var e = j.length - 1; e >= 0; e--) {
				...
				i.find('.js--result-answer').text(o),
					i.find('.js--result-image').attr({ src: 'img/' + m.appType + '/answer-' + r + '-' + a + '.png', alt: o });
			}
			var s = t();
		...
		function h(e) {
			for (var t = j.length - 1; t >= 0; t--) if (j[t].questionId === e.questionId) return !1;
			return !0;
		}
		function q(e, t) {
			var n = {
		...
		var j = [],
			M = !1;
		return { start: c, restart: f, jumpToEnd: y, goToQuestion: u, selectAnswer: w, sendQuoteForm: T, removeLastAnswer: p };
	}
	function n() {
	...
	var d = { all: $('.section'), initial: $('.initial'), results: $('.results'), questions: $('.question') },
		m = e(),
		f = new t();
	d.initial.on('click', '.js--start', n),
		d.questions.on('click', '.js--answer', a),
		d.questions.on('click', '.js--previous', r),
		d.results.on('click', '.js--change', o),
		d.results.on('click', '.js--restart', i),
		d.results.on('click', '.js--toggle-results', s),
		d.results.on('click', '.js--start-project', u),
		$('#quoteForm').on('click', '.js--form-send', l),
		c();
	var g = { color: $('body').data('theme-color') };
	$('#legalModalTrigger').animatedModal({ modalTarget: 'legalModal', color: g.color }),
		$('#findUsModalTrigger').animatedModal({ modalTarget: 'findUsModal', color: g.color }),
		$('#aboutModalTrigger').animatedModal({ modalTarget: 'aboutModal', color: g.color }),
		$('#quoteModalTrigger').animatedModal({ modalTarget: 'quoteModal', color: g.color }),
		$('#moreInfoModalModalTrigger').animatedModal({ modalTarget: 'moreInfoModal', color: g.color }),
...
!(function () {
	...
	function c(t) {
		return new n(function (e, n) {
			function o(n) {
				return function (o) {
					(s[n] = o), (a += 1), a == t.length && e(s);
				};
			}
			var a = 0,
				s = [];
			0 == t.length && e(s);
			for (var r = 0; r < t.length; r += 1) i(t[r]).c(o(r), n);
		});
	}
	function l(t) {
		return new n(function (e, n) {
			...
			return new Promise(function (t, i) {
				if (c() && !r()) {
					...
					e(function () {
						function e() {
							var e;
							(e = (-1 != v && -1 != y) || (-1 != v && -1 != g) || (-1 != y && -1 != g)) &&
								((e = v != y && v != g && y != g) ||
									(null === f &&
										((e = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent)),
										(f = !!e && (536 > parseInt(e[1], 10) || (536 === parseInt(e[1], 10) && 11 >= parseInt(e[2], 10))))),
									(e = f && ((v == b && y == b && g == b) || (v == E && y == E && g == E) || (v == x && y == x && g == x)))),
								(e = !e)),
								e && (N.parentNode && N.parentNode.removeChild(N), clearTimeout(u), t(s));
						}
						function r() {
...
var fontNormal = new FontFaceObserver('Gotham Rounded', { weight: 300 }),
	fontBold = new FontFaceObserver('Gotham Rounded', { weight: 700 });
